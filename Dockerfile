...
RUN apt-get update && apt-get upgrade -y && \
	DEBIAN_FRONTEND="noninteractive" apt-get install -y  --no-install-recommends wget gnupg software-properties-common unzip p7zip cabextract curl nano libsndfile && \
